return PlaceObj('ModDef', {
	...
	'last_changes', "4.5.3 Refactor of inefficient code\n\nConsider the below bad versions, as they broke herd growth rates and did not properly store stats/references correctly\n4.5.1.1 (4.05-113)\n4.5.2 (4.05-115)\n4.5.2.1 (4.05-116)\n\n1. Bugfix: All mod options are now stored at global scope (reverted 4.5.1.1 change)\n\n2. QoL for me: All count of the tames animals are stored in map variables\n\n\nPlease see the git in the mod description for open bugs, and even submit your own\nFeedback is always welcome to fine tune the balance of things!",
	'SpellCheck', true,
	'id', "rtw6tLg",
	'author', "Ark Builder",
	'version_major', 4,
